...
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.81.0 (eeb90cda1 2024-09-04) (Arch Linux rust 1:1.81.0-1)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.81.0 (eeb90cda1 2024-09-04) (Arch Linux rust 1:1.81.0-1)";
